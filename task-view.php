        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">View Task</h1>
                        ...
                        <div class="col-12 col-md-11">
                            <table class="table table-hover table-responsive bg-light">
                                ...
                                if (!$conn) {
                                    ...
                                    $userSelect = "SELECT * FROM `task` where `emp_id`='$id'";
                                ...
                                ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="updatetask.php?id=<?php echo $row['id'] ?>" class="btn btn-primary">Update</a> </td>
                                            </tr>
