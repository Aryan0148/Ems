                ...
                <section class="container py-5">
                    <div class="row justify-content-center py-5">
                        <div class="col-12 col-md-6">
                            ...
                            ?>
                                    <form class="card p-5" action="updatequerytaskadmin.php" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="desc" class="form-control" id="Description" required value="<?php echo $row['Description']; ?>">
                                        </div>
                                        <!-- desc Input End -->
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" name="date" required class="form-control" id="Date" value="<?php echo $row['Ddate']; ?>">
                                        </div>
                                        <!-- date Input End -->
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" required name="emp_id" class="form-control" id="Emp_id" value="<?php echo $row['emp_id']; ?>">
                                        </div>
                                        <!-- emp-id Input End -->
